...
if (type === "many" && note === "") {
  output.textContent = "Please provide a note explaining your travel preferences when selecting many campuses.";
  return;
}
...
if (type === "many" && selectedCampuses.length < 2) {
  output.textContent = "Please select at least two campuses if you choose many campuses.";
  return;
}
